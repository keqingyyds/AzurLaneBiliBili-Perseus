...
if [ ! -f "com.bilibili.AzurLane.apk" ]; then
    ...
    wget https://github.com/keqingyyds/AzurLaneBiliBili-Perseus/releases/download/untagged-02fd9aa34986014b4a31/blhx_8.2.1_0820_1_20240830_041443_51682.apk -O com.bilibili.AzurLane.apk -q
    echo "apk downloaded !"
